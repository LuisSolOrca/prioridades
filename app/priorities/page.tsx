                  ...
                  <div className="mt-2 pt-2 border-t border-blue-200 dark:border-blue-700">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-orange-600 dark:text-orange-400 mt-2 space-y-2">
                          {currentWeekMilestones.map((milestone: any) => {
                            ...
                            return (
                              <div key={milestone._id} className="border-l-2 border-orange-400 dark:border-orange-600 pl-2">
                                <div className="flex items-center gap-2">
                                  <span className={`font-medium ${milestone.isCompleted ? 'line-through' : ''}`}>
                                    {milestone.title}
                                  </span>
                                ...
                                {totalDeliverables > 0 && (
                                  <div className="mt-1 ml-2 space-y-0.5">
                                    <div className="text-xs font-semibold text-orange-700 dark:text-orange-300">
                                      Entregables ({completedDeliverables}/{totalDeliverables}):
                                    </div>
                                    <ul className="list-disc list-inside space-y-0.5">
                                      {milestone.deliverables.map((deliverable: any, idx: number) => (
                                        <li key={idx} className={`text-xs ${deliverable.isCompleted ? 'line-through text-gray-500 dark:text-gray-400' : 'text-orange-600 dark:text-orange-400'}`}>
                                          {deliverable.title}
                                        </li>
                                      ))}
                                    </ul>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-green-600 dark:text-green-400 mt-2 space-y-2">
                          {nextWeekMilestones.map((milestone: any) => {
                            ...
                            const totalDeliverables = milestone.deliverables?.length || 0;
                            return (
                              <div key={milestone._id} className="border-l-2 border-green-400 dark:border-green-600 pl-2">
                                <div className="flex items-center gap-2">
                                  <span className={`font-medium ${milestone.isCompleted ? 'line-through' : ''}`}>
                                    {milestone.title}
                                  </span>
                                ...
                                {totalDeliverables > 0 && (
                                  <div className="mt-1 ml-2 space-y-0.5">
                                    ...
                                    <ul className="list-disc list-inside space-y-0.5">
                                      {milestone.deliverables.map((deliverable: any, idx: number) => (
                                        <li key={idx} className={`text-xs ${deliverable.isCompleted ? 'line-through text-gray-500 dark:text-gray-400' : 'text-green-600 dark:text-green-400'}`}>
                                          {deliverable.title}
                                        </li>
                                      ))}
                                    </ul>
