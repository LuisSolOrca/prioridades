    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Frecuencia de Reportes</h2>
        ...
        <div className="bg-blue-50 rounded-lg border border-blue-200 p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">🧪 Enviar Reporte de Prueba</h2>
        ...
        <div className="bg-yellow-50 rounded-lg border border-yellow-200 p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">⚙️ Configuración de Cron</h2>
