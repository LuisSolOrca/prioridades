                  ...
                  {conditions.map((condition, index) => (
                    <div key={index} className="flex items-center space-x-2 bg-blue-50 p-3 rounded-lg">
                      ...
                      >
                        ...
                        <option value="title_contains">Título contiene texto</option>
                      ...
                      {(condition.type === 'title_contains' || condition.type === 'description_contains') && (
                        <input
                          ...
                          onChange={(e) => updateCondition(index, 'value', e.target.value)}
                          className="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-sm"
                          placeholder={condition.type === 'title_contains' ? 'Texto a buscar en el título' : 'Texto a buscar en la descripción'}
                        />
                      )}
                      ...
                      {action.type === 'add_comment' && (
                        <div>
                          <input
                            ...
                            onChange={(e) => updateAction(index, 'message', e.target.value)}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Ej: Actualización automática: {{completion}}% completado"
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            Usa placeholders: {'{{title}}'}, {'{{status}}'}, {'{{completion}}'}, {'{{owner}}'}, {'{{initiative}}'}
                          </p>
                        ...
                        <>
                          ...
                          <div>
                            <input
                              ...
                              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                              placeholder="Ej: Alerta: {{title}} requiere atención"
                            />
                            <p className="text-xs text-gray-500 mt-1">
                              Asunto del email (puedes usar placeholders)
                            </p>
                          </div>
                          <div>
                            <textarea
                              ...
                              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                              rows={3}
                              placeholder="Ej: La prioridad {{title}} está en estado {{status}} con {{completion}}% de avance."
                            />
                            <p className="text-xs text-gray-500 mt-1">
                              Usa placeholders: {'{{title}}'}, {'{{status}}'}, {'{{completion}}'}, {'{{owner}}'}, {'{{initiative}}'}, {'{{weekStart}}'}, {'{{weekEnd}}'}
                            </p>
                          </div>
                        </>
                      )}
