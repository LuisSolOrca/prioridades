...
export const SEARCHABLE_ENTITIES: Record<SearchableEntityType, SearchableEntityConfig> = {
  ...
  emailTemplate: {
    ...
    urlPattern: '/crm/email-templates/{id}/edit',
    icon: 'Mail',
    priority: 50,
  },
  channel: {
  ...
  strategicInitiative: {
    ...
    titleField: 'name',
    subtitleFields: ['description'],
    urlPattern: '/admin/initiatives/{id}',
    icon: 'Target',
    priority: 10,
  },
  pipeline: {
